/**************
 File: parser.c
 --------------
 Implements the interface given in parser.h.
 */
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
...
static void S_Expression ()
{
    ...
    {
        // Since it starts with (, it's a list of one or more s_expressions
        printf("%s(\n", indent);
    ...
    {
        // It's a list of zero s_expressions (because the lexical analyzer treats '()' as a single token)
        printf("%s()\n", indent);
    }
    else
    {
